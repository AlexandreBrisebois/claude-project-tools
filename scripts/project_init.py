...
# Ensure the scripts/ directory is on the path so project_sync can be imported
# when this script is run from the project root (e.g. python3 scripts/project_init.py)
