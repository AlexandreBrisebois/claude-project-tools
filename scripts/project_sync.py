...
def main():
    ...
    push_p.add_argument("files", nargs="*", help="Files to push (default: all files in project/)")

    # Pull
    pull_p = subparsers.add_parser("pull")
    pull_p.add_argument("files", nargs="*", help="Files to pull (default: all files in project)")
    ...
    try:
        if args.command == "push":
            ...
            uploaded = client.push_files(files)
            ...
            pulled = client.pull_files(files)
